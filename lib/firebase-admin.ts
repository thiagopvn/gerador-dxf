...
const projectId = process.env.FIREBASE_PROJECT_ID || 'remarcacao-chassi';
const clientEmail = process.env.FIREBASE_CLIENT_EMAIL || 'firebase-adminsdk-3w8uu@remarcacao-chassi.iam.gserviceaccount.com';
